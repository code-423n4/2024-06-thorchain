...
type ApiTradeAccountsRequest struct {
	ctx context.Context
	ApiService *TradeAccountsApiService
	asset string
	height *int64
}
...
func (r ApiTradeAccountsRequest) Execute() ([]TradeAccountResponse, *http.Response, error) {
	return r.ApiService.TradeAccountsExecute(r)
}
...
Returns all trade accounts for an asset
 ...
 @param asset
 @return ApiTradeAccountsRequest
*/
...
func (a *TradeAccountsApiService) TradeAccountsExecute(r ApiTradeAccountsRequest) ([]TradeAccountResponse, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  []TradeAccountResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradeAccountsApiService.TradeAccounts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/thorchain/trade/accounts/{asset}"
