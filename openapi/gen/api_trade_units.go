...
type ApiTradeUnitsRequest struct {
	ctx context.Context
	ApiService *TradeUnitsApiService
	height *int64
}
...
func (r ApiTradeUnitsRequest) Execute() ([]TradeUnitResponse, *http.Response, error) {
	return r.ApiService.TradeUnitsExecute(r)
}
...
func (a *TradeUnitsApiService) TradeUnitsExecute(r ApiTradeUnitsRequest) ([]TradeUnitResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradeUnitsApiService.TradeUnits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/thorchain/trade/units"
