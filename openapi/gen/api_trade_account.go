...
type ApiTradeAccountRequest struct {
	ctx context.Context
	ApiService *TradeAccountApiService
	address string
	height *int64
}
...
func (r ApiTradeAccountRequest) Execute() (*TradeAccountResponse, *http.Response, error) {
	return r.ApiService.TradeAccountExecute(r)
}
...
func (a *TradeAccountApiService) TradeAccountExecute(r ApiTradeAccountRequest) (*TradeAccountResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradeAccountApiService.TradeAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/thorchain/trade/account/{address}"
