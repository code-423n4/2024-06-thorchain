...
// newTxOutStorageV124 will create a new instance of TxOutStore.
func newTxOutStorageV124(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager, gasManager GasManager) *TxOutStorageV124 {
	return &TxOutStorageV124{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV124) cachedTryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi TxOutItem, minOut cosmos.Uint) (bool, error) {
...
func (tos *TxOutStorageV124) prepareTxOutItem(ctx cosmos.Context, toi TxOutItem) ([]TxOutItem, types.Uint, error) {
	var outputs []TxOutItem
...
func (tos *TxOutStorageV124) addToBlockOut(ctx cosmos.Context, mgr Manager, item TxOutItem, outboundHeight int64) error {
...
func (tos *TxOutStorageV124) nativeTxOut(ctx cosmos.Context, mgr Manager, toi TxOutItem) error {
...
func (tos *TxOutStorageV124) getPendingOutbounds(ctx cosmos.Context, asset common.Asset) []TxOutItem {
...
func (tos *TxOutStorageV124) deductVaultPendingOutbounds(vault Vault, pendingOutbounds []TxOutItem) Vault {
