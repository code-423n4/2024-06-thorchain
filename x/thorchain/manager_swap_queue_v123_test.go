...
type SwapQueueV123Suite struct{}

var _ = Suite(&SwapQueueV123Suite{})

func (s SwapQueueV123Suite) TestGetTodoNum(c *C) {
	queue := newSwapQueueV123(keeper.KVStoreDummy{})
...
func (s SwapQueueV123Suite) TestScoreMsgs(c *C) {
...
func (s SwapQueueV123Suite) TestStreamingSwapSelection(c *C) {
	ctx, k := setupKeeperForTest(c)
	queue := newSwapQueueV123(k)
...
func (s SwapQueueV123Suite) TestStreamingSwapOutbounds(c *C) {
	...
	queue := newSwapQueueV123(mgr.Keeper())
