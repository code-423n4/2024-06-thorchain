...
// NetworkMgrV131 is going to manage the vaults
type NetworkMgrV131 struct {
	k          keeper.Keeper
	txOutStore TxOutStore
	eventMgr   EventManager
}

// newNetworkMgrV131 create a new vault manager
func newNetworkMgrV131(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *NetworkMgrV131 {
	return &NetworkMgrV131{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
	}
...
func (vm *NetworkMgrV131) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV131) BeginBlock(ctx cosmos.Context, mgr Manager) error {
	return vm.spawnDerivedAssets(ctx, mgr)
}

func (vm *NetworkMgrV131) suspendVirtualPool(ctx cosmos.Context, mgr Manager, derivedAsset common.Asset, suspendReasonErr error) {
...
func (vm *NetworkMgrV131) CalcAnchor(ctx cosmos.Context, mgr Manager, asset common.Asset) (cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV131) spawnDerivedAssets(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV131) SpawnDerivedAsset(ctx cosmos.Context, asset common.Asset, mgr Manager) {
	var err error
	layer1Asset := asset
...
func (vm *NetworkMgrV131) fetchMedianSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) (slip int64) {
...
func (vm *NetworkMgrV131) calculateMedianSlip(ctx cosmos.Context, asset common.Asset, mgr Manager) int64 {
...
func (vm *NetworkMgrV131) EndBlock(ctx cosmos.Context, mgr Manager) error {
	if ctx.BlockHeight() == genesisBlockHeight {
...
func (vm *NetworkMgrV131) migrateFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV131) paySaverYield(ctx cosmos.Context, asset common.Asset, runeAmt cosmos.Uint) error {
...
func (vm *NetworkMgrV131) POLCycle(ctx cosmos.Context, mgr Manager) error {
...
func (mv *NetworkMgrV131) fetchPOLPools(ctx cosmos.Context, mgr Manager) (Pools, []int64) {
	var pools Pools
...
func (vm *NetworkMgrV131) addPOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
...
func (vm *NetworkMgrV131) removePOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
	polAddress, asgardAddress common.Address,
	signer cosmos.AccAddress,
...
func (vm *NetworkMgrV131) TriggerKeygen(ctx cosmos.Context, nas NodeAccounts) error {
...
func (vm *NetworkMgrV131) RotateVault(ctx cosmos.Context, vault Vault) error {
	active, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		return err
	}
...
func (vm *NetworkMgrV131) cleanupAsgardIndex(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV131) RecallChainFunds(_ cosmos.Context, _ common.Chain, _ Manager, _ common.PubKeys) error {
	return fmt.Errorf("dev error: RecallChainFunds is obsolete")
}

func (vm *NetworkMgrV131) withdrawSavers(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool, err error) {
	handler := NewInternalHandler(mgr)
...
func (vm *NetworkMgrV131) withdrawLPs(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) (done bool) {
	handler := NewInternalHandler(mgr)
	lpPerIteration := mgr.Keeper().GetConfigInt64(ctx, constants.RagnarokProcessNumOfLPPerIteration)
	totalCount := int64(0)
...
func (vm *NetworkMgrV131) withdrawLiquidity(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) error {
	if pool.Status == PoolSuspended {
...
func (vm *NetworkMgrV131) UpdateNetwork(ctx cosmos.Context, constAccessor constants.ConstantValues, gasManager GasManager, eventMgr EventManager) error {
...
func (vm *NetworkMgrV131) getAvailablePoolsRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *NetworkMgrV131) getVaultsLiquidityRune(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *NetworkMgrV131) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *NetworkMgrV131) calcPoolDeficit(lpDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *NetworkMgrV131) calcBlockRewards(availablePoolsRune, vaultsLiquidityRune, effectiveSecurityBond, totalEffectiveBond, totalReserve, totalLiquidityFees cosmos.Uint, emissionCurve, blocksPerYear int64) (cosmos.Uint, cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV131) getPoolShare(
...
func (vm *NetworkMgrV131) deductPoolRewardDeficit(ctx cosmos.Context, pools Pools, totalLiquidityFees, lpDeficit cosmos.Uint) ([]PoolAmt, error) {
...
func (vm *NetworkMgrV131) checkPoolRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV131) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools Pools) bool {
...
func (vm *NetworkMgrV131) redeemSynthAssetToReserve(ctx cosmos.Context, p Pool) error {
...
func (vm *NetworkMgrV131) ragnarokPool(ctx cosmos.Context, mgr Manager, p Pool) error {
