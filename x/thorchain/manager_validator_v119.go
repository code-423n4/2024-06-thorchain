...
// newValidatorMgrV119 create a new instance of ValidatorMgrV119
func newValidatorMgrV119(k keeper.Keeper, networkMgr NetworkManager, txOutStore TxOutStore, eventMgr EventManager) *ValidatorMgrV119 {
	return &ValidatorMgrV119{
		k:          k,
...
func (vm *ValidatorMgrV119) churn(ctx cosmos.Context) error {
...
// asgard vaults
func (vm *ValidatorMgrV119) splitNext(ctx cosmos.Context, nas NodeAccounts, asgardSize int64) []NodeAccounts {
...
func (vm *ValidatorMgrV119) checkContractUpgrade(ctx cosmos.Context, mgr Manager, removedNodeKeys common.PubKeys) error {
...
func (vm *ValidatorMgrV119) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *ValidatorMgrV119) payNodeAccountBondAward(ctx cosmos.Context, lastChurnHeight int64, na NodeAccount, totalBondReward, totalEffectiveBond, bondHardCap cosmos.Uint, mgr Manager) error {
...
func (vm *ValidatorMgrV119) processRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *ValidatorMgrV119) getPendingTxOut(ctx cosmos.Context) (int64, error) {
...
func (vm *ValidatorMgrV119) ragnarokProtocolStage1(ctx cosmos.Context, mgr Manager) error {
	return vm.recallYggFunds(ctx, mgr)
}

func (vm *ValidatorMgrV119) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager) error {
	// Ragnarok Protocol
...
func (vm *ValidatorMgrV119) distributeBondReward(ctx cosmos.Context, mgr Manager) error {
	var resultErr error
...
func (vm *ValidatorMgrV119) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *ValidatorMgrV119) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager) error {
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
...
func (vm *ValidatorMgrV119) recallYggFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *ValidatorMgrV119) setupValidatorNodes(ctx cosmos.Context, height int64) error {
	if height != genesisBlockHeight {
...
func (vm *ValidatorMgrV119) getLastChurnHeight(ctx cosmos.Context) int64 {
	vaults, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		ctx.Logger().Error("Failed to get Asgard vaults", "error", err)
...
func (vm *ValidatorMgrV119) getScore(ctx cosmos.Context, slashPts, lastChurnHeight int64) cosmos.Uint {
...
func (vm *ValidatorMgrV119) findBadActors(ctx cosmos.Context, minSlashPointsForBadValidator, badValidatorRedline int64) (NodeAccounts, error) {
...
func (vm *ValidatorMgrV119) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *ValidatorMgrV119) findLowBondActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *ValidatorMgrV119) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *ValidatorMgrV119) markOldActor(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV119) markLowBondActor(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV119) markBadActor(ctx cosmos.Context, minSlashPointsForBadValidator, redline int64) (int64, error) {
...
func (vm *ValidatorMgrV119) markLowVersionValidators(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV119) findLowVersionValidators(ctx cosmos.Context, maxNodesToFind int64) (NodeAccounts, error) {
...
func (vm *ValidatorMgrV119) clearLeaveScores(ctx cosmos.Context) error {
	active, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return err
	}
...
func (vm *ValidatorMgrV119) markReadyActors(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV119) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int) (NodeAccounts, bool, error) {
