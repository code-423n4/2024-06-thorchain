...
type nodeAddressValidatorAddressPairV124 struct {
	nodeAddress      cosmos.AccAddress
	validatorAddress crypto.Address
}

// newSlasherV124 create a new instance of Slasher
func newSlasherV124(keeper keeper.Keeper, eventMgr EventManager) *SlasherV124 {
	return &SlasherV124{keeper: keeper, eventMgr: eventMgr}
}
...
func (s *SlasherV124) BeginBlock(ctx cosmos.Context, req abci.RequestBeginBlock, constAccessor constants.ConstantValues) {
	...
	var validatorAddresses []nodeAddressValidatorAddressPairV124
	for _, na := range nas {
		...
		var pair nodeAddressValidatorAddressPairV124
...
func (s *SlasherV124) slashNotObserving(ctx cosmos.Context, txHash common.TxID, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV124) checkSignerAndSlash(ctx cosmos.Context, nodes NodeAccounts, blockHeight int64, signers []cosmos.AccAddress, constAccessor constants.ConstantValues) {
...
func (s SlasherV124) slashAndUpdateNodeAccount(ctx cosmos.Context, na types.NodeAccount, coin common.Coin, vault types.Vault, totalBond, totalSlashAmountInRune cosmos.Uint) cosmos.Uint {
...
func (s *SlasherV124) updatePoolFromSlash(ctx cosmos.Context, pool types.Pool, stolenAsset common.Coin, runeCreditAmt cosmos.Uint, mgr Manager) {
...
func (s *SlasherV124) needsNewVault(ctx cosmos.Context, mgr Manager, nas int, signingTransPeriod, startHeight int64, inhash common.TxID, pk common.PubKey) bool {
