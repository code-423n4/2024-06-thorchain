...
type SwapQueueV116Suite struct{}

var _ = Suite(&SwapQueueV116Suite{})

func (s SwapQueueV116Suite) TestGetTodoNum(c *C) {
	queue := newSwapQueueV116(keeper.KVStoreDummy{})
...
func (s SwapQueueV116Suite) TestScoreMsgs(c *C) {
...
func (s SwapQueueV116Suite) TestStreamingSwapSelection(c *C) {
	ctx, k := setupKeeperForTest(c)
	queue := newSwapQueueV116(k)
...
func (s SwapQueueV116Suite) TestStreamingSwapOutbounds(c *C) {
	...
	queue := newSwapQueueV116(mgr.Keeper())
