...
type TxOutStoreV128Suite struct{}

var _ = Suite(&TxOutStoreV128Suite{})

func (s TxOutStoreV128Suite) TestAddGasFees(c *C) {
...
func (s TxOutStoreV128Suite) TestEndBlock(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	txOutStore := newTxOutStorageV128(w.keeper, w.mgr.GetConstants(), w.mgr.EventMgr(), w.mgr.GasMgr())
...
func (s TxOutStoreV128Suite) TestAddOutTxItem(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStoreV128Suite) TestAddOutTxItem_OutboundHeightDoesNotGetOverride(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStoreV128Suite) TestAddOutTxItemNotEnoughForFee(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
...
func (s TxOutStoreV128Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStoreV128Suite) TestCalcTxOutHeight(c *C) {
...
func (s TxOutStoreV128Suite) TestAddOutTxItem_MultipleOutboundWillBeScheduledAtTheSameBlockHeight(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStoreV128Suite) TestAddOutTxItemInteractionWithPool(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStoreV128Suite) TestAddOutTxItemSendingFromRetiredVault(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStoreV128Suite) TestAddOutTxItem_SecurityVersusOutboundNumber(c *C) {
...
func (s TxOutStoreV128Suite) TestAddOutTxItem_VaultStatusVersusOutboundNumber(c *C) {
	// Within this example vault bonds are treated as zero, using only assets to represent security.
...
func (s *TxOutStoreV128Suite) TestSplitCloutEqualDistribution(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
...
func (s *TxOutStoreV128Suite) TestSplitCloutOneSideExceeds(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
...
func (s *TxOutStoreV128Suite) TestSplitCloutUnevenDistribution(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
...
func (s *TxOutStoreV128Suite) TestSplitCloutOverLimit(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
...
func (s *TxOutStoreV128Suite) TestSplitCloutWithZeroRuneValue(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
...
func (s *TxOutStoreV128Suite) TestSplitCloutCloutsAtLimit(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
	swapperCloutLimit := cosmos.NewUint(100)
...
func (s *TxOutStoreV128Suite) TestSplitCloutRuneValueExceedingClouts(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageV128{}
	swapperCloutLimit := cosmos.NewUint(100)
	clout1 := cosmos.NewUint(40)
