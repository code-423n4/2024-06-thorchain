...
type ValidatorMgrV124TestSuite struct{}

var _ = Suite(&ValidatorMgrV124TestSuite{})

func (vts *ValidatorMgrV124TestSuite) SetUpSuite(_ *C) {
	SetupConfigForTest()
}

func (vts *ValidatorMgrV124TestSuite) TestChurnWithChainHalt(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(60) // churn height
	mgr := NewDummyMgr()
	mgr.K = k
	networkMgr := newValidatorMgrV124(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV124TestSuite) TestSetupValidatorNodes(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
	mgr := NewDummyMgr()
	validatorMgr := newValidatorMgrV124(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	...
	validatorMgr1 := newValidatorMgrV124(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	...
	validatorMgr2 := newValidatorMgrV124(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV124TestSuite) TestRagnarokForMainnet(c *C) {
	ctx, mgr := setupManagerForTest(c)
	networkMgr := newValidatorMgrV124(mgr.Keeper(), mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV124TestSuite) TestLowerVersion(c *C) {
	ctx, mgr := setupManagerForTest(c)
...
func (vts *ValidatorMgrV124TestSuite) TestBadActors(c *C) {
	ctx, mgr := setupManagerForTest(c)
...
func (vts *ValidatorMgrV124TestSuite) TestFindBadActors(c *C) {
	ctx, mgr := setupManagerForTest(c)
	ctx = ctx.WithBlockHeight(1000)
...
func (vts *ValidatorMgrV124TestSuite) TestFindLowBondActor(c *C) {
	ctx, mgr := setupManagerForTest(c)
	ctx = ctx.WithBlockHeight(1000)
...
func (vts *ValidatorMgrV124TestSuite) TestRagnarokBond(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
...
func (vts *ValidatorMgrV124TestSuite) TestGetChangedNodes(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
...
func (vts *ValidatorMgrV124TestSuite) TestSplitNext(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewDummyMgr()
	networkMgr := newValidatorMgrV124(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(networkMgr, NotNil)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_EmptyNodeAccounts(c *C) {
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_SingleNodeAccount(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_AllSameBondAddress(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_DifferentBondAddresses(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_SameBondSameAddress(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_ZeroAsgardSize(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_NegativeAsgardSize(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_AsgardSizeLargerThanLen(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_MultipleDuplicates(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV124TestSuite) TestSplitNext_MultipleDuplicatesOfDiffSizes(c *C) {
	var vm ValidatorMgrVCUR
	ctx, _ := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV124TestSuite) TestFindCounToRemove(c *C) {
	// remove one
...
func (vts *ValidatorMgrV124TestSuite) TestFindMaxAbleToLeave(c *C) {
...
func (vts *ValidatorMgrV124TestSuite) TestFindNextVaultNodeAccounts(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewDummyMgrWithKeeper(k)
	validatorMgr := newValidatorMgrV124(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(validatorMgr, NotNil)
...
func (vts *ValidatorMgrV124TestSuite) TestFindNextVaultNodeAccountsMax(c *C) {
	// test that we don't exceed the targetCount
	ctx, mgr := setupManagerForTest(c)
	validatorMgr := newValidatorMgrV124(mgr.Keeper(), mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(validatorMgr, NotNil)
	// create active nodes
	for i := 0; i < 12; i++ {
		na := GetRandomValidatorNode(NodeActive)
...
func (vts *ValidatorMgrV124TestSuite) TestFindNextVaultNodeAccountsBFT(c *C) {
...
func (vts *ValidatorMgrV124TestSuite) TestWeightedBondReward(c *C) {
	ctx, k := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV124TestSuite) TestActiveNodeRequestToLeaveShouldBeStandby(c *C) {
	var err error
	ctx, mgr := setupManagerForTest(c)
