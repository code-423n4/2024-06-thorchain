...
// newYggMgrV116 create a new instance of YggMgrV116 which implement YggManager interface
func newYggMgrV116(keeper keeper.Keeper) *YggMgrV116 {
	return &YggMgrV116{
		keeper: keeper,
	}
}
...
func (ymgr YggMgrV116) Fund(ctx cosmos.Context, mgr Manager) error {
	...
	stopFundYggdrasil := mgr.Keeper().GetConfigInt64(ctx, constants.StopFundYggdrasil)
	if stopFundYggdrasil > 0 {
...
// yggdrasil pool
func (ymgr YggMgrV116) sendCoinsToYggdrasil(ctx cosmos.Context, coins common.Coins, ygg Vault, mgr Manager) (int, error) {
	var count int
...
func (ymgr YggMgrV116) shouldFundYggdrasil(ctx cosmos.Context, asgard, ygg Vault, chain common.Chain) bool {
...
func (ymgr YggMgrV116) calcTargetYggCoins(pools []Pool, ygg Vault, yggBond, totalBond, yggFundLimit, minRuneDepth cosmos.Uint) (common.Coins, error) {
...
func (ymgr YggMgrV116) abandonYggdrasilVaults(ctx cosmos.Context, mgr Manager) error {
...
func (ymgr YggMgrV116) slash(ctx cosmos.Context, slasher Slasher, mgr Manager, pk common.PubKey, ygg Vault) error {
