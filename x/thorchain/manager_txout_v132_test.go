...
type TxOutStorageV132Suite struct{}

var _ = Suite(&TxOutStorageV132Suite{})

func (s TxOutStorageV132Suite) TestAddGasFees(c *C) {
...
func (s TxOutStorageV132Suite) TestEndBlock(c *C) {
...
func (s TxOutStorageV132Suite) TestAddOutTxItem(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStorageV132Suite) TestAddOutTxItem_OutboundHeightDoesNotGetOverride(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStorageV132Suite) TestAddOutTxItemNotEnoughForFee(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
...
func (s TxOutStorageV132Suite) TestAddOutTxItemWithoutBFT(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStorageV132Suite) TestCalcTxOutHeight(c *C) {
...
func (s TxOutStorageV132Suite) TestAddOutTxItem_MultipleOutboundWillBeScheduledAtTheSameBlockHeight(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
...
func (s TxOutStorageV132Suite) TestAddOutTxItemInteractionWithPool(c *C) {
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStorageV132Suite) TestAddOutTxItemSendingFromRetiredVault(c *C) {
	SetupConfigForTest()
	w := getHandlerTestWrapper(c, 1, true, true)
...
func (s TxOutStorageV132Suite) TestAddOutTxItem_SecurityVersusOutboundNumber(c *C) {
...
func (s TxOutStorageV132Suite) TestAddOutTxItem_VaultStatusVersusOutboundNumber(c *C) {
	// Within this example vault bonds are treated as zero, using only assets to represent security.
...
func (s *TxOutStorageV132Suite) TestSplitCloutEqualDistribution(c *check.C) {
...
func (s *TxOutStorageV132Suite) TestSplitCloutOneSideExceeds(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStorageV132Suite) TestSplitCloutUnevenDistribution(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStorageV132Suite) TestSplitCloutOverLimit(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStorageV132Suite) TestSplitCloutWithZeroRuneValue(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
...
func (s *TxOutStorageV132Suite) TestSplitCloutCloutsAtLimit(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
	swapperCloutLimit := cosmos.NewUint(100)
...
func (s *TxOutStorageV132Suite) TestSplitCloutRuneValueExceedingClouts(c *check.C) {
	ctx, _ := setupManagerForTest(c)
	tos := TxOutStorageVCUR{}
	swapperCloutLimit := cosmos.NewUint(100)
	clout1 := cosmos.NewUint(40)
