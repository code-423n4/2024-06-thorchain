...
type ValidatorMgrV123TestSuite struct{}

var _ = Suite(&ValidatorMgrV123TestSuite{})

func (vts *ValidatorMgrV123TestSuite) SetUpSuite(_ *C) {
	SetupConfigForTest()
}

func (vts *ValidatorMgrV123TestSuite) TestChurnWithChainHalt(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(60) // churn height
	mgr := NewDummyMgr()
	mgr.K = k
	networkMgr := newValidatorMgrV123(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV123TestSuite) TestSetupValidatorNodes(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
	mgr := NewDummyMgr()
	validatorMgr := newValidatorMgrV123(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	...
	validatorMgr1 := newValidatorMgrV123(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	...
	validatorMgr2 := newValidatorMgrV123(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV123TestSuite) TestRagnarokForMainnet(c *C) {
	ctx, mgr := setupManagerForTest(c)
	networkMgr := newValidatorMgrV123(mgr.Keeper(), mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV123TestSuite) TestLowerVersion(c *C) {
	ctx, mgr := setupManagerForTest(c)
...
func (vts *ValidatorMgrV123TestSuite) TestBadActors(c *C) {
	ctx, mgr := setupManagerForTest(c)
...
func (vts *ValidatorMgrV123TestSuite) TestFindBadActors(c *C) {
	ctx, mgr := setupManagerForTest(c)
	ctx = ctx.WithBlockHeight(1000)
...
func (vts *ValidatorMgrV123TestSuite) TestFindLowBondActor(c *C) {
	ctx, mgr := setupManagerForTest(c)
	ctx = ctx.WithBlockHeight(1000)
...
func (vts *ValidatorMgrV123TestSuite) TestRagnarokBond(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
...
func (vts *ValidatorMgrV123TestSuite) TestGetChangedNodes(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
...
func (vts *ValidatorMgrV123TestSuite) TestSplitNext(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewDummyMgr()
	networkMgr := newValidatorMgrV123(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(networkMgr, NotNil)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_EmptyNodeAccounts(c *C) {
	var vm ValidatorMgrV123
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_SingleNodeAccount(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_AllSameBondAddress(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_DifferentBondAddresses(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_SameBondSameAddress(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_ZeroAsgardSize(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_NegativeAsgardSize(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_AsgardSizeLargerThanLen(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_MultipleDuplicates(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV123TestSuite) TestSplitNext_MultipleDuplicatesOfDiffSizes(c *C) {
	var vm ValidatorMgrV123
	ctx, _ := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV123TestSuite) TestFindCounToRemove(c *C) {
	// remove one
...
func (vts *ValidatorMgrV123TestSuite) TestFindMaxAbleToLeave(c *C) {
...
func (vts *ValidatorMgrV123TestSuite) TestFindNextVaultNodeAccounts(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewDummyMgrWithKeeper(k)
	validatorMgr := newValidatorMgrV123(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(validatorMgr, NotNil)
...
func (vts *ValidatorMgrV123TestSuite) TestFindNextVaultNodeAccountsMax(c *C) {
	// test that we don't exceed the targetCount
	ctx, mgr := setupManagerForTest(c)
	validatorMgr := newValidatorMgrV123(mgr.Keeper(), mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(validatorMgr, NotNil)
	// create active nodes
	for i := 0; i < 12; i++ {
		na := GetRandomValidatorNode(NodeActive)
...
func (vts *ValidatorMgrV123TestSuite) TestFindNextVaultNodeAccountsBFT(c *C) {
...
func (vts *ValidatorMgrV123TestSuite) TestWeightedBondReward(c *C) {
	ctx, k := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV123TestSuite) TestActiveNodeRequestToLeaveShouldBeStandby(c *C) {
	var err error
	ctx, mgr := setupManagerForTest(c)
