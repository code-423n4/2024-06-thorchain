...
type SwapQueueV117Suite struct{}

var _ = Suite(&SwapQueueV117Suite{})

func (s SwapQueueV117Suite) TestGetTodoNum(c *C) {
	queue := newSwapQueueV117(keeper.KVStoreDummy{})
...
func (s SwapQueueV117Suite) TestScoreMsgs(c *C) {
...
func (s SwapQueueV117Suite) TestStreamingSwapSelection(c *C) {
	ctx, k := setupKeeperForTest(c)
	queue := newSwapQueueV117(k)
...
func (s SwapQueueV117Suite) TestStreamingSwapOutbounds(c *C) {
	...
	queue := newSwapQueueV117(mgr.Keeper())
