...
// newSwapQueueV121 create a new vault manager
func newSwapQueueV121(k keeper.Keeper) *SwapQueueV121 {
	return &SwapQueueV121{
		k:       k,
...
func (vm *SwapQueueV121) FetchQueue(ctx cosmos.Context) (swapItems, error) { // nolint
...
func (vm *SwapQueueV121) getTodoNum(queueLen, minSwapsPerBlock, maxSwapsPerBlock int64) int64 {
...
// swapItem list
func (vm *SwapQueueV121) scoreMsgs(ctx cosmos.Context, items swapItems, synthVirtualDepthMult int64) (swapItems, error) {
...
func (vm *SwapQueueV121) getLiquidityFeeAndSlip(ctx cosmos.Context, pool Pool, sourceCoin common.Coin, item *swapItem, virtualDepthMult int64) {
