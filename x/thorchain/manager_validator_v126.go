...
// newValidatorMgrV126 create a new instance of ValidatorMgrV126
func newValidatorMgrV126(k keeper.Keeper, networkMgr NetworkManager, txOutStore TxOutStore, eventMgr EventManager) *ValidatorMgrV126 {
	return &ValidatorMgrV126{
		k:          k,
...
func (vm *ValidatorMgrV126) churn(ctx cosmos.Context) error {
...
// asgard vaults
func (vm *ValidatorMgrV126) splitNext(ctx cosmos.Context, nas NodeAccounts, asgardSize int64) []NodeAccounts {
...
func (vm *ValidatorMgrV126) checkContractUpgrade(ctx cosmos.Context, mgr Manager, removedNodeKeys common.PubKeys) error {
...
func (vm *ValidatorMgrV126) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *ValidatorMgrV126) payNodeAccountBondAward(ctx cosmos.Context, lastChurnHeight int64, na NodeAccount, totalBondReward, totalEffectiveBond, bondHardCap cosmos.Uint, mgr Manager) error {
...
func (vm *ValidatorMgrV126) processRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *ValidatorMgrV126) getPendingTxOut(ctx cosmos.Context) (int64, error) {
...
func (vm *ValidatorMgrV126) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager) error {
	// Ragnarok Protocol
...
func (vm *ValidatorMgrV126) distributeBondReward(ctx cosmos.Context, mgr Manager) error {
	var resultErr error
...
func (vm *ValidatorMgrV126) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *ValidatorMgrV126) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager) error {
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
...
func (vm *ValidatorMgrV126) setupValidatorNodes(ctx cosmos.Context, height int64) error {
	if height != genesisBlockHeight {
...
func (vm *ValidatorMgrV126) getLastChurnHeight(ctx cosmos.Context) int64 {
	vaults, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		ctx.Logger().Error("Failed to get Asgard vaults", "error", err)
...
func (vm *ValidatorMgrV126) getScore(ctx cosmos.Context, slashPts, lastChurnHeight int64) cosmos.Uint {
...
func (vm *ValidatorMgrV126) findBadActors(ctx cosmos.Context, minSlashPointsForBadValidator, badValidatorRedline int64) (NodeAccounts, error) {
...
func (vm *ValidatorMgrV126) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *ValidatorMgrV126) findLowBondActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return na, err
...
func (vm *ValidatorMgrV126) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *ValidatorMgrV126) markOldActor(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV126) markLowBondActor(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV126) markBadActor(ctx cosmos.Context, minSlashPointsForBadValidator, redline int64) (int64, error) {
...
func (vm *ValidatorMgrV126) markLowVersionValidators(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV126) findLowVersionValidators(ctx cosmos.Context, maxNodesToFind int64) (NodeAccounts, error) {
...
func (vm *ValidatorMgrV126) clearLeaveScores(ctx cosmos.Context) error {
	active, err := vm.k.ListActiveValidators(ctx)
	if err != nil {
		return err
	}
...
func (vm *ValidatorMgrV126) markReadyActors(ctx cosmos.Context) error {
...
func (vm *ValidatorMgrV126) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int) (NodeAccounts, bool, error) {
