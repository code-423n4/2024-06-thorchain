...
// newNetworkMgrV120 create a new vault manager
func newNetworkMgrV120(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *NetworkMgrV120 {
	return &NetworkMgrV120{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
	}
...
func (vm *NetworkMgrV120) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV120) suspendVirtualPool(ctx cosmos.Context, mgr Manager, derivedAsset common.Asset, suspendReasonErr error) {
...
func (vm *NetworkMgrV120) spawnDerivedAssets(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV120) paySaverYield(ctx cosmos.Context, asset common.Asset, runeAmt cosmos.Uint) error {
...
func (mv *NetworkMgrV120) fetchPOLPools(ctx cosmos.Context, mgr Manager) Pools {
	var pools Pools
...
func (vm *NetworkMgrV120) addPOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
...
func (vm *NetworkMgrV120) removePOLLiquidity(
	ctx cosmos.Context,
	pool Pool,
	polAddress, asgardAddress common.Address,
	signer cosmos.AccAddress,
...
func (vm *NetworkMgrV120) cleanupAsgardIndex(ctx cosmos.Context) error {
...
func (vm *NetworkMgrV120) withdrawLiquidity(ctx cosmos.Context, pool Pool, na NodeAccount, mgr Manager) error {
	if pool.Status == PoolSuspended {
...
func (vm *NetworkMgrV120) getTotalProvidedLiquidityRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *NetworkMgrV120) getTotalActiveBond(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *NetworkMgrV120) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *NetworkMgrV120) calcPoolDeficit(lpDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *NetworkMgrV120) calcBlockRewards(totalProvidedLiquidity, totalBonded, totalReserve, totalLiquidityFees cosmos.Uint, emissionCurve, incentiveCurve, blocksPerYear int64) (cosmos.Uint, cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *NetworkMgrV120) getPoolShare(incentiveCurve int64, totalProvidedLiquidity, totalBonded, totalRewards cosmos.Uint) cosmos.Uint {
	/*
		Pooled : Share
		0 : 100%
...
func (vm *NetworkMgrV120) deductPoolRewardDeficit(ctx cosmos.Context, pools Pools, totalLiquidityFees, lpDeficit cosmos.Uint) ([]PoolAmt, error) {
...
func (vm *NetworkMgrV120) checkPoolRagnarok(ctx cosmos.Context, mgr Manager) error {
...
func (vm *NetworkMgrV120) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools Pools) bool {
...
func (vm *NetworkMgrV120) redeemSynthAssetToReserve(ctx cosmos.Context, p Pool) error {
...
func (vm *NetworkMgrV120) ragnarokPool(ctx cosmos.Context, mgr Manager, p Pool) error {
