...
type ValidatorMgrV121TestSuite struct{}

var _ = Suite(&ValidatorMgrV121TestSuite{})

func (vts *ValidatorMgrV121TestSuite) SetUpSuite(_ *C) {
	SetupConfigForTest()
}

func (vts *ValidatorMgrV121TestSuite) TestChurnWithChainHalt(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(60) // churn height
	mgr := NewDummyMgr()
	mgr.K = k
	networkMgr := newValidatorMgrV121(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV121TestSuite) TestSetupValidatorNodes(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
	mgr := NewDummyMgr()
	validatorMgr := newValidatorMgrV121(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	...
	validatorMgr1 := newValidatorMgrV121(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	...
	validatorMgr2 := newValidatorMgrV121(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV121TestSuite) TestRagnarokForMainnet(c *C) {
	ctx, mgr := setupManagerForTest(c)
	networkMgr := newValidatorMgrV121(mgr.Keeper(), mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
...
func (vts *ValidatorMgrV121TestSuite) TestLowerVersion(c *C) {
	ctx, mgr := setupManagerForTest(c)
...
func (vts *ValidatorMgrV121TestSuite) TestBadActors(c *C) {
	ctx, mgr := setupManagerForTest(c)
...
func (vts *ValidatorMgrV121TestSuite) TestFindBadActors(c *C) {
	ctx, mgr := setupManagerForTest(c)
	ctx = ctx.WithBlockHeight(1000)
...
func (vts *ValidatorMgrV121TestSuite) TestFindLowBondActor(c *C) {
	ctx, mgr := setupManagerForTest(c)
	ctx = ctx.WithBlockHeight(1000)
...
func (vts *ValidatorMgrV121TestSuite) TestRagnarokBond(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
...
func (vts *ValidatorMgrV121TestSuite) TestGetChangedNodes(c *C) {
	ctx, k := setupKeeperForTest(c)
	ctx = ctx.WithBlockHeight(1)
...
func (vts *ValidatorMgrV121TestSuite) TestSplitNext(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewDummyMgr()
	networkMgr := newValidatorMgrV121(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(networkMgr, NotNil)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_EmptyNodeAccounts(c *C) {
	var vm ValidatorMgrV121
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_SingleNodeAccount(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_AllSameBondAddress(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_DifferentBondAddresses(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_SameBondSameAddress(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_ZeroAsgardSize(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_NegativeAsgardSize(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_AsgardSizeLargerThanLen(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_MultipleDuplicates(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (s *ValidatorMgrV121TestSuite) TestSplitNext_MultipleDuplicatesOfDiffSizes(c *C) {
	var vm ValidatorMgrV121
	ctx, _ := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV121TestSuite) TestFindCounToRemove(c *C) {
	// remove one
...
func (vts *ValidatorMgrV121TestSuite) TestFindMaxAbleToLeave(c *C) {
...
func (vts *ValidatorMgrV121TestSuite) TestFindNextVaultNodeAccounts(c *C) {
	ctx, k := setupKeeperForTest(c)
	mgr := NewDummyMgrWithKeeper(k)
	validatorMgr := newValidatorMgrV121(k, mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(validatorMgr, NotNil)
...
func (vts *ValidatorMgrV121TestSuite) TestFindNextVaultNodeAccountsMax(c *C) {
	// test that we don't exceed the targetCount
	ctx, mgr := setupManagerForTest(c)
	validatorMgr := newValidatorMgrV121(mgr.Keeper(), mgr.NetworkMgr(), mgr.TxOutStore(), mgr.EventMgr())
	c.Assert(validatorMgr, NotNil)
	// create active nodes
	for i := 0; i < 12; i++ {
		na := GetRandomValidatorNode(NodeActive)
...
func (vts *ValidatorMgrV121TestSuite) TestFindNextVaultNodeAccountsBFT(c *C) {
...
func (vts *ValidatorMgrV121TestSuite) TestWeightedBondReward(c *C) {
	ctx, k := setupKeeperForTest(c)
...
func (vts *ValidatorMgrV121TestSuite) TestActiveNodeRequestToLeaveShouldBeStandby(c *C) {
	var err error
	ctx, mgr := setupManagerForTest(c)
