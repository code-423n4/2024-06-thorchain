...
type SwapQueueV120Suite struct{}

var _ = Suite(&SwapQueueV120Suite{})

func (s SwapQueueV120Suite) TestGetTodoNum(c *C) {
	queue := newSwapQueueV120(keeper.KVStoreDummy{})
...
func (s SwapQueueV120Suite) TestScoreMsgs(c *C) {
...
func (s SwapQueueV120Suite) TestStreamingSwapSelection(c *C) {
	ctx, k := setupKeeperForTest(c)
	queue := newSwapQueueV120(k)
...
func (s SwapQueueV120Suite) TestStreamingSwapOutbounds(c *C) {
	...
	queue := newSwapQueueV120(mgr.Keeper())
